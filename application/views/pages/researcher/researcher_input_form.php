	  	...
	  	<div class="form-group">
			...
			<div class="form-group">
	  		<label for="gender"class="col-sm-2 control-label">Gender :</label>
		  		<div class="col-sm-10 control-label">
					<?php echo form_radio('sex', 'male', 'class="radio-inline form-control" checked="checked"'); ?> Male <br>
					<?php echo form_radio('sex', 'female', 'class="radio-inline form-control"'); ?> Female <br><br>
				</div>
			</div>	
			...
			<center><?php echo form_submit('addResearcher', 'Add Researcher', 'class="btn btn-lg btn-primary" '); ?></center>
