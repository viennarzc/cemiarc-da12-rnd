<div class="container-fluid">
		<div class="panel panel-default">
				  <div class="panel-heading">
				    <h2 class="panel-title"><span class="glyphicon glyphicon glyphicon-list-alt"></span> <strong>List of Result and Discussion</strong> </h2>
				  </div>
											...
											<?php else: ?>
								        		<?php foreach($researches as $research): ?>
									        		<tr>
														...
														<strong><small>Results and Discussions:</small></strong><br>
														<p><?php echo $research->results_and_discussions; ?></p><br>
