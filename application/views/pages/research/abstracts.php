<div class="container-fluid">
	<div class="panel panel-default">
					  <div class="panel-heading">
					    <h2 class="panel-title"><span class="glyphicon glyphicon glyphicon-list-alt"></span> <strong>List of Abstract</strong> </h2>
					  </div>
											...
											<?php else: ?>
								        		<?php foreach($researches as $research): ?>
									        		<tr>
														...
														<strong><small>Abstract:</small></strong><br>
														<p><?php echo $research->abstract; ?></p><br>
