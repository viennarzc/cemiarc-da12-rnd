...
<div class="panel panel-default">
  <div class="panel-heading">
    <h2 class="panel-title"><span class="glyphicon glyphicon glyphicon-list-alt"></span>  Implementing Agency List</h2>
  </div>
  <div class="panel-body">
        ...
        <?php else: ?>
          <?php foreach ($implementing_agencies as $agency): ?>
            <h4><i class="fa fa-users"></i> <?php echo anchor('implementing_agencies/implementing_agency_individual/'.$agency->agency_id, $agency->agency_name); ?></h2><br><hr>
          <?php endforeach; ?>
        <?php endif; ?>
        <center>
        <?php echo $pages; ?>
