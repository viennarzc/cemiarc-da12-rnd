...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('/assets/css/styles_add.css');?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/bootstrap-select/dist/css/bootstrap-select.css'); ?>">
   	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/bootstrap-datatables/media/css/jquery.dataTables.css'); ?>">
